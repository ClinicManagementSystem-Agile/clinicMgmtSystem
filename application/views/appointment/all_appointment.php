...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            ...
            <h2>Appointment</h2>
            <small class="text-muted">List of All Appointment</small>
			</div>
                                ...
                                if (count($appointments)):
                                    ...
                                    foreach ($appointments as $app): $i++;
                                        ...
                                        <tr <?php if ($amount > 0): ?>style="background-color: #f2dede;" <?php endif; ?>>
                                            <td><?php echo $i; ?></td>
                                            <td><a href="<?php echo base_url();?>patient/patient_profile/<?php echo $app['patient_id'];?>" class="edit"><?php echo $app['patient_id']; ?></a></td>
                                            <td><?php $CI =& get_instance();$CI->load->model('patient_model');

$patient = $CI->patient_model->get_patient_by_id($app['patient_id']);?>
				...
				<a href="<?php echo base_url();?>patient/patient_profile/<?php echo $patient->id;?>" class="edit">
                                                <?php if (!empty($patient->photo)) { ?>
													<img src="<?php echo base_url();?>assets/upload/patient_img/<?php echo $patient->photo;?>" width="80"height="80"><?php }else{ ?><img src="<?php echo base_url();?>assets/upload/patient_img/avatar.png" width="80"height="80"><?php }?></a>
                                                    ...
                                                    if (!empty($visits)) {
                                                        foreach ($visits as $visit):
                                                            ...
                                                            <li style="float: left; padding-left: 5px;">
                                                                <a target="_blank"
                                                                   href="<?php echo base_url(); ?>assets/upload/visit/<?php echo $visit['file_chosen']; ?>"><i class="fa fa-file"></i></a>&nbsp; <?php echo $visit['file_chosen']; ?>
                                                            </li>
