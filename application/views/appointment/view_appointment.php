...
//                    var decision = confirm("Do you want to remove event?");
                        $.ajax({
                            ...
                            success: function (data) {
                               ...
                               time_tot1 = str1.split(":", 1);
                               time_tot2 = str2.split(":", 1);
                               if(time_tot1>12 || time_tot2>12)
                            {
                                    var start_time = str1.slice(0, -3) + 'pm';
                                    var end_time =  str2.slice(0, -3) + 'pm';
                            }
                            else
                                {
...
//                alert(data);
            ...
            if(data=='nursing')
           {
                 window.location = '<?php echo  base_url(); ?>appointment/view_all_appointment/';   
            }
           else
               {
                             if(save_method=='update')
    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <small class="text-muted">Doctor Appointment Calender</small>
				...
				<div class="col-md-4 col-sm-4"><a href="<?php echo base_url();?>appointment/view_appointment">View all appointments</a></div>
			</div>
			<div class="row">
