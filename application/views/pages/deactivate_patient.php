...
<section class="content">
    <div class="container-fluid">
        <div class="block-header noprint">
            ...
            <h2>All patients</h2>
            <small class="text-muted">List of Deactivated Patients</small>
			</div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Clinic Deactivated Patient List</h2>
                        </div>
                    <div class="body">
...
&nbsp; -->
                                                                                                ...
                                                                                                <?php $ledger_id = $this->patient->get_patient_ledger_id($patient['id'])->id; ?>
<a href="<?php echo base_url().'ledger/view_ledger_details/'.$ledger_id;?>"  target='_blank'>
									View Ledger</a>
                                                                                             
                                            </td>
                                              <td><?php echo $patient['deactivate_reason'] ?></td>
                                        </tr>
                                    <?php endforeach; ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="row">
        <div class="col-md-12">
            <form name="myform" action="<?php echo base_url();?>patient/activate_patient">
